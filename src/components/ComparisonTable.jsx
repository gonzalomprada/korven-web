    ...
    <section className="py-24 relative bg-black/20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-white mb-4">¿Por qué elegir Gonerus?</h2>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="py-4 px-6 text-cyan-400 font-bold bg-cyan-900/10 rounded-t-xl border-t border-x border-cyan-500/20">Gonerus</th>
              </tr>
            </thead>
